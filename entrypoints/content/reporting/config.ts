...
export const fieldMappingConfig = [
  ...
  { field: 'account_id', labels: ['account_id', '账户编号', 'account id', '账户id', 'act_id'] },
  { field: 'campaign_id', labels: ['campaign_id', '广告系列编号', 'campaign id', '系列id', 'c_id'] },
  { field: 'adset_id', labels: ['adset_id', '广告组编号', 'adset id', '组id', 'g_id'] },
  { field: 'ad_id', labels: ['ad_id', '广告编号', 'ad id', '广告id', 'adid'] },
